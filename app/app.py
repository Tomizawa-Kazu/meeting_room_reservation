...
if page == 'users':
  ...
  with st.form(key='booking'):
    ...
    end_time = st.time_input('終了時刻:',value=datetime.time(hour=21,minute=0))
  ...
  if submit_button:
    ...
    elif start_time < datetime.time(hour=9, minute=0, second=0) or datetime.time(hour=21, minute=0, second=0) < end_time :
      st.error('利用時間は9:00～21:00になります')
